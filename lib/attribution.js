...
/**
 * First-party analytics sink. Deliberately distinct from the registration
 * endpoint: registration PII must never be posted here.
 */
export const ANALYTICS_ENDPOINT = 'https://metrics.unlockedecom.co/api/attribution-event';
...
const PII_EXACT_NORMALIZED = new Set([
  ...
  // Instagram registration identity — never analytics / URL / storage.
  'instagramusername',
  'instagram',

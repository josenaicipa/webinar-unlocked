/** Exact live class start (jueves 30 julio 2026, 8:00 PM Colombia). */
export const WEBINAR_START_ISO = '2026-07-31T01:00:00Z';

/** Owner-verified end: 60-minute class (9:00 PM Colombia). */
export const WEBINAR_END_ISO = '2026-07-31T02:00:00Z';
...
export const WEBINAR_DETAILS =
  'Clase en vivo Protocolo Unlocked. Jueves 30 de julio de 2026, 8:00 PM hora de Colombia. En vivo y sin costo de inscripción.';
...
export function toUtcBasic(iso = WEBINAR_START_ISO) {
  ...
  if (!Number.isFinite(d.getTime())) {
    return iso === WEBINAR_END_ISO ? '20260731T020000Z' : '20260731T010000Z';
  }

/** Exact live class start (martes 4 agosto 2026, 7:00 PM Colombia). */
export const WEBINAR_START_ISO = '2026-08-05T00:00:00Z';

/** Zoom-verified end: 120-minute class (9:00 PM Colombia). */
export const WEBINAR_END_ISO = '2026-08-05T02:00:00Z';
...
export const WEBINAR_DETAILS =
  'Clase en vivo Protocolo Unlocked. Martes 4 de agosto de 2026, 7:00 PM hora de Colombia. En vivo y sin costo de inscripción.';
...
export function toUtcBasic(iso = WEBINAR_START_ISO) {
  ...
  if (!Number.isFinite(d.getTime())) {
    return iso === WEBINAR_END_ISO ? '20260805T020000Z' : '20260805T000000Z';
  }

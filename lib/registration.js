...
export const WEBINAR_ID = '84076939284';
export const WEBINAR_FECHA = '2026-07-30';
export const WEBINAR_HORA = '20:00';
 ...
 * Only a JSON object with a strict boolean `ok === true` counts as persisted;
 * everything else (null, arrays, scalars, `{}`, `ok:'true'`, `ok:1`, `ok:false`)
 * fails closed so no Meta Lead / redirect can fire on an unconfirmed write.
 * @param {unknown} data
 * @returns {boolean}
 */
